...
export const deleteGig = async (req, res, next) => {
  try {
    ...
    console.log('Delete request received for gigId:', gigId);
    ...
    if (!gig) {
      console.log('Gig not found for gigId:', gigId);
    ...
    console.log('Gig deleted successfully for gigId:', gigId);
    return res.status(200).json({ message: "Gig deleted successfully" });
  } catch (err) {
    console.log('Delete gig error:', err);
    return res.status(500).send("Internal Server Error");
  }
};

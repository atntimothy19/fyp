...
function Pricing() {
  ...
  return (
    <>
      {gigData && (
        <div className="sticky top-24 mb-10 h-max w-full md:w-96 px-4 md:px-0">
          <div className="border p-5 md:p-10 flex flex-col gap-5">
            <div className="flex justify-between items-center">
              <h4 className="text-sm md:text-md font-normal text-[#74767e]">
                {gigData.shortDesc}
              </h4>
              <h6 className="font-medium text-lg">${gigData.price}</h6>
            </div>
            <div>
              <div className="text-[#62646a] font-semibold text-sm flex flex-col md:flex-row gap-3 md:gap-6">
                <div className="flex items-center gap-2">
                  <FiClock className="text-lg md:text-xl" />
                  <span>{gigData.deliveryTime} Days Delivery</span>
                </div>
                <div className="flex items-center gap-2">
                  <FiRefreshCcw className="text-lg md:text-xl" />

  ...
  return (
    <>
      {gigData && currentImage !== "" && (
        <div className="flex flex-col gap-3 px-4 py-2 md:px-8">
          <h2 className="text-xl md:text-2xl font-bold text-[#404145] mb-1">
            {gigData.title}
          </h2>
          ...
          <div className="flex flex-col gap-4">
            <div className="max-h-[500px] max-w-full md:max-h-[1000px] md:max-w-[1000px] overflow-hidden">
              <Image
          ...
          <div>
            <h3 className="text-2xl md:text-3xl my-3 md:my-5 font-medium text-[#404145]">
              About this gig
            </h3>
            <div>

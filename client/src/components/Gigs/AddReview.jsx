...
function AddReview() {
  ...
  return (
    <div className="mb-10 px-4">
      <h3 className="text-xl my-4 font-normal text-[#404145]">
        Give a Review
      </h3>
      <div className="flex flex-col items-start justify-start gap-3">
        ...
        <button
          className="flex items-center bg-[#1DBF73] text-white py-2 justify-center text-md relative rounded px-5 w-full"
          onClick={addReview}
        >
          Add Review
        </button>
